...
namespace myoddweb
{
  namespace directorywatcher
  {
     ...
     */
    MonitorWinDirectories::MonitorWinDirectories(const Monitor& parent, const unsigned long bufferLength) :
     ...
     */
    unsigned long MonitorWinDirectories::GetNotifyFilter() const
    {
